...
unset($__errorArgs, $__bag); ?>" 
                               id="unit" name="unit" value="<?php echo e(old('unit', $product->unit)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control <?php $__errorArgs = ['minimum_stock'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                               id="minimum_stock" name="minimum_stock" value="<?php echo e(old('minimum_stock', $product->minimum_stock)); ?>" 
                               min="0" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="alert alert-info">
                    <strong>Current Stock on Hand:</strong> <?php echo e($product->quantity_on_hand); ?> <?php echo e($product->unit); ?>
...
<?php echo $__env->make('layouts.base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\backend\resources\views/products/edit.blade.php ENDPATH**/ ?>
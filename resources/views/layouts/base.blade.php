...
<nav class="navbar top-navbar navbar-expand-lg sticky-top">
    <div class="container-fluid">
        ...
        {{-- Mobile sidebar toggle (Bootstrap 5 Offcanvas trigger) --}}
        ...
        <div class="collapse navbar-collapse" id="topNav">
            <ul class="navbar-nav ms-auto align-items-center gap-2">
                @auth
                    {{-- Role badge --}}
                    <li class="nav-item">
                        <span class="badge {{ Auth::user()->isAdmin() ? 'bg-warning text-dark' : 'bg-success' }} rounded-pill py-2 px-3">
                            <i class="bi bi-{{ Auth::user()->isAdmin() ? 'shield-check' : 'person-check' }} me-1"></i>
...
{{-- ═══════════ MOBILE OFFCANVAS SIDEBAR (Bootstrap 5 Component) ═══════════ --}}
@auth
...
{{-- ═══════ TOAST CONTAINER (Bootstrap 5 Toasts) ═══════ --}}
